    ...
    <main class="flex-grow container mx-auto py-8">
      ...
      <form method="POST" action="/register" class="max-w-sm mx-auto">
        <div class="mb-5">
          ...
          <input type="text" name="name" id="name" value="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ivan" required />
        </div>
      ...
      <div class="mt-4 text-center">
        <span class="text-sm text-gray-900 dark:text-white">Вы уже авторизованы? <a href="/login" class="hover:underline text-blue-500">Войти</a></span>
      </div>
    </main>
